...
### `graph.CapitalizedAddDefaultNamespaces()`

TODO: docs

### `graph.CapitalizedAddNamespace(pref, ns)`

TODO: docs

### `graph.CapitalizedEmit(*)`

TODO: docs

### `graph.CapitalizedLoadNamespaces()`

TODO: docs

### `graph.CapitalizedUri(s)`
...
### `path.CapitalizedAnd(path)`

TODO: docs

### `path.CapitalizedAs(tags)`

TODO: docs

### `path.CapitalizedBack(tag)`

TODO: docs

### `path.CapitalizedBoth(*)`

TODO: docs

### `path.CapitalizedCount()`

TODO: docs

### `path.CapitalizedDifference(path)`

TODO: docs

### `path.CapitalizedExcept(path)`

TODO: docs

### `path.CapitalizedFilter(args)`

TODO: docs

### `path.CapitalizedFollow(path)`

TODO: docs

### `path.CapitalizedFollowR(path)`

TODO: docs

### `path.CapitalizedFollowRecursive(*)`

TODO: docs

### `path.CapitalizedForEach(*)`

TODO: docs

### `path.CapitalizedGetLimit(limit)`
...
### `path.CapitalizedInPredicates()`

TODO: docs

### `path.CapitalizedIntersect(path)`
...
### `path.CapitalizedLabelContext(*)`

TODO: docs

### `path.CapitalizedLabels()`

TODO: docs

### `path.CapitalizedLimit(limit)`
...
### `path.CapitalizedOutPredicates()`

TODO: docs

### `path.CapitalizedSave(*)`

TODO: docs

### `path.CapitalizedSaveInPredicates(tag)`

TODO: docs

### `path.CapitalizedSaveOpt(*)`

TODO: docs

### `path.CapitalizedSaveOptR(*)`

TODO: docs

### `path.CapitalizedSaveOutPredicates(tag)`

TODO: docs

### `path.CapitalizedSaveR(*)`

TODO: docs

### `path.CapitalizedSkip(offset)`

TODO: docs

### `path.CapitalizedTag(tags)`

TODO: docs

### `path.CapitalizedTagArray(*)`

TODO: docs

### `path.CapitalizedTagValue()`

TODO: docs

### `path.CapitalizedToArray(*)`

TODO: docs

### `path.CapitalizedToValue()`

TODO: docs

### `path.CapitalizedUnion(path)`

TODO: docs

### `path.CapitalizedUnique()`

TODO: docs

### `path.CapitalizedtoArray(call, withTags)`

TODO: docs

### `path.CapitalizedtoValue(withTags)`
